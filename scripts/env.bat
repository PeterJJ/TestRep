...
call G:\Xilinx\Vivado\%VER%\settings64.bat
...
SET PATH=G:\Xilinx\Vivado\%VER%\tps\win64\git-1.9.5\bin;%PATH%
SET PATH=G:\Xilinx\Vivado\%VER%\tps\share\vim\vim74;%PATH%
SET PATH=G:\Xilinx\Vivado_HLS\%VER%\msys\bin;%PATH%
